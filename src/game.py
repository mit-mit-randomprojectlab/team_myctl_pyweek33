...
# TODO: put classes for in-game objects in other source files and import them here
    ...
    def on_event(self, events):
        for event in events:
            if event.type == KEYDOWN and event.key == K_ESCAPE:
                self.director.change_scene(None, []) # quit game for now, probably change later
